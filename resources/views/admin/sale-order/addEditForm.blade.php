...
<div class="row">
    ...
    <div class="card" >
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                <h3 class="card-title">    
                    <a href="{{ route('admin.sale-order.index') }}" class="btn btn-info float-end mt-2">
            ...
            <div class="row">
                <div class="col-md-8 regCustomer">
                        <!-- registered customer -->
                            ...
                            @endphp
							@if(isset($so->id) && $so->id!='' && $action=='UpdateSaleOrder')
								<form role="form" action="{{ route('admin.sale-order.update', $so->id) }}" method="post" enctype="multipart/form-data" autocomplete="off" id="billingForm">
								 @method('PUT')
							@else
								<form role="form" action="{{ route('admin.sale-order.store') }}" method="post" enctype="multipart/form-data" autocomplete="off" id="billingForm">
            ...
            <div class=" ">
                <div class="row">
                    <div class="wd-sl-modalbtn">
                        <button type="submit" class="btn btn-primary  waves-effect waves-lightt">@if($action=='InqueryToSaleOrder') Convert to Order @elseif($action=='UpdateSaleOrder') Update Order @else Create Order @endif</button>
...
function DeleteRow(obj)
    {
      ...
      if(confirm('Are you sure you want to delete this item Permanently?'))
        {
            if($oldID>=1 && $requestType=='UpdateSaleOrder'){
                $.getJSON("{{url('admin/action')}}/"+'sale-order-itemRemove/'+$oldID, function(data){
