...
<!-- === form == -->
                            ...
                            <!-- form start ;;;-->
								<form role="form" action="{{ route('admin.inquery-conversion-store',$requestID) }}" method="post" enctype="multipart/form-data" autocomplete="off" id="billingForm">
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <tfoot>
                                <tr class="bg-primary text-white">
                                    ...
                                    <td><input type="text" name="sumQtyTotal" class="text-white" readonly></td>
                                    <td hidden><input type="text" name="sumRateTotal" class="text-white"></td>
                                    <td hidden><input type="text" name="sumDisTotal" class="text-white"></td>
                                    <td><input type="text" name="sumNetTotal" class="text-white" readonly></td>
                                    <td></td>
                                </tr>
                            </tfoot>
                        </table>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Note :-</label>
                                <textarea class="form-control" row="2" name="remark" readonly>{{ old('remark',$inquiry->remark)}}</textarea>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="otherCharges" class="form-control" value="{{old('otherCharges',$inquiry->other_charges)}}" onkeyup="calculate()" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">Freight</div>
                                <div class="col-md-6">
                                    <input type="text" name="freight" class="form-control" value="{{old('freight',$inquiry->freight)}}" onkeyup="calculate()" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">Parcels</div>
                                <div class="col-md-6">
                                    <input type="text" name="parcels" value="{{old('parcels',$inquiry->parcels)}}" class="form-control" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="billDiscount" class="form-control" value="{{old('discount',$inquiry->discount)}}" onkeyup="calculate()" readonly>
            ...
            <div class=" ">
                <div class="row">
                    <div class="wd-sl-modalbtn">
                        <button type="submit" class="btn btn-danger  waves-effect waves-lightt">{{ $inquiry->id?'Convert To Inquiry':'Save' }}</button>
