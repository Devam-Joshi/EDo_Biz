                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8 p-3">
                                <div class="row">
                                    <div class="col-md-4 bg-light">
                                        <div class="form-group">
                                            Bill No : 
                                            <input type="hidden"  name="paymentType" value="payment" class="form-control" checked>
                                        </div>
                                    </div>
                                    <div class="col-md-8 ">
                                ...
                                <div class="row">
                                    <div class="col-md-4 bg-light">
                                        <label>Payment Mode {{$payment->txn_method}}</label>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <select class="select2 form-control" name="txn_method" id="txn_method" >
                                                <option value="">--Select Mode---</option>
                                                    <option value="CASH" {{ old('txn_method',$payment->txn_method)=='CASH'? 'selected':''}}>CASH</option>
                                                    <option value="CHEQUE" {{ old('txn_method',$payment->txn_method)=='CHEQUE'? 'selected':''}}>CHEQUE</option>
                                                    <option value="NEFT" {{ old('txn_method',$payment->txn_method)=='NEFT'? 'selected':''}}>NEFT</option>
                                                    <option value="IMPS" {{ old('txn_method',$payment->txn_method)=='IMPS'? 'selected':''}}>IMPS</option>
                                                    <option value="UPI" {{ old('txn_method',$payment->txn_method)=='UPI'? 'selected':''}}>UPI</option>
                                                    <option value="other" {{ old('txn_method',$payment->txn_method)=='other'? 'selected':''}}>other</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input id="account_id" name="account_id" class="form-control" value="{{old('account_id',$payment->party_id)}}" hidden>
                                        </div>
