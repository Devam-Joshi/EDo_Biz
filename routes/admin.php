...
Route::group(['middleware' => 'Is_Admin'], function () {
    ...
    Route::group(['namespace' => 'Admin'], function () {
        ...
        Route::get('new-user/create', [UsersController::class, 'create'])->name('user.createNew');
        Route::post('new-user/save', [UsersController::class, 'save'])->name('user.saveNew');
        ...
        Route::get('permission/status_update/{id}', 'PermissionController@status_update')->name('permission.status_update');
        Route::get('permission/listing', 'PermissionController@listing')->name('permission.listing');
